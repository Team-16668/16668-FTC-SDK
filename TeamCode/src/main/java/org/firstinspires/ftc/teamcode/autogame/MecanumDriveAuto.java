...
import org.firstinspires.ftc.teamcode.autogame.ui.Cursor;
import org.firstinspires.ftc.teamcode.autogame.ui.Ring;
...
public class MecanumDriveAuto extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.71797691039;
    ...
    private GamepadDashboardInterface ui;

    public MecanumDriveAuto(HardwareMap hardwareMap, GamepadDashboardInterface ui) {
    ...
    public void turnToAsync(double angle) {
        ...
        turnStart = clock.seconds();
        mode = MecanumDriveAuto.Mode.TURN;
    }
